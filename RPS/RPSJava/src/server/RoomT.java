...
public class RoomT implements AutoCloseable {
	private static SocketServer server;// used to refer to accessible server functions
	private String name;
	private String gamename;
	private final static Logger log = Logger.getLogger(RoomT.class.getName());
	...
	protected void joinGame(String game, ServerThread client) {
		server.joinGame(game, client);
	}
