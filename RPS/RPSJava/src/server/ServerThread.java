...
public class ServerThread extends Thread {
	...
	private RoomT currentRoom;// what room we are in, should be lobby by default
	...
	protected synchronized RoomT getCurrentRoom() {
		return currentRoom;
	}

	protected synchronized void setCurrentRoom(RoomT room) {
		if (room != null) {
			currentRoom = room;
		} else {
	...
	public ServerThread(Socket myClient, RoomT room) throws IOException {
